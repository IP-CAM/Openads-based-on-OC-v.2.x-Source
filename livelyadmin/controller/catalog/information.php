...
class ControllerCatalogInformation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm('catalog/information/add')) {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm('catalog/information/edit')) {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete('catalog/information/delete')) {
	...
	protected function getForm() {
		...
		} elseif (!empty($information_info['meta_keyword'])) {
