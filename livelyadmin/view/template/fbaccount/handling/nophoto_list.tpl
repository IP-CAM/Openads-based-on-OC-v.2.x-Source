...
<!--	
function filter() {
	url = 'index.php?route=fbaccount/nophoto&token=<?php echo $token; ?>';
	var paramArr=[];
        ...
        buttons:{
            'Save':function(){
                $('#bulk-form').ajaxSubmit({
                    url:'index.php?route=fbaccount/nophoto/bulk&token=<?php echo $token;?>',
                    type:'Post',
                    dataType:'json',
        ...
        buttons:{
          'Copy':function(){
                ...
                if(copy_status.length){
                    $.ajax({
                        url:'index.php?route=fbaccount/nophoto/ajax_data&token=<?php echo $token;?>',
                        type:'Post',
