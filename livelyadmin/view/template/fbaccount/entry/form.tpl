	        ...
	        <div class="form-group">
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-sm-10">
	            	...
	            	<option value="<?php echo $artist['user_id']?>" <?php echo ($artist_id == $artist['user_id']) ? 'selected':'';?>><?php echo $artist['name'];?></option>
	            	<?php }?>
	            	</select>
	            </div>
	          </div>
	          ...
	          <div class="form-group">
	            <label class="control-label col-sm-2"><?php echo $entry_cb_link; ?></label>
	            <div class="col-sm-10">
	            	<input type="text" name="cb_link" value="<?php echo $cb_link;?>" class="form-control" /><?php if ($error_cb_link) { ?>
	              	<span class="error"><?php echo $error_cb_link; ?></span>
	              	<?php } ?></div>
	          </div>     
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-sm-10">
	            	<textarea name="note" id="fbnote" class="form-control"><?php echo $note?></textarea></div>
	          </div>
	          <div class="form-group">
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-sm-10">
	            	<input type="text" name="post_level" value="<?php echo $post_level;?>" class="form-control" /></div>
	          </div>
	          <div class="form-group">
	            <label class="control-label col-sm-2"><?php echo $entry_maintain_level; ?></label>
	            <div class="col-sm-10">
	            	<input type="text" name="maintain_level" value="<?php echo $maintain_level;?>" class="form-control" /></div>
	          </div>
