            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'time_name') { ?>
                    <a href="<?php echo $sort_time_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_time_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($item['time_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['time_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['time_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $item['time_name']; ?></td>
