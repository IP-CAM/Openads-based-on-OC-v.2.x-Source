          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'start_date') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'sort') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($item['match_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['match_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['match_id']; ?>" />
                    <?php } ?></td>
