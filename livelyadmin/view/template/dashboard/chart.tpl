...
<?php if(false){ ?>>
<script type="text/javascript" src="<?php echo TPL_JS ?>flot/jquery.flot.js"></script> 
<script type="text/javascript" src="<?php echo TPL_JS ?>flot/jquery.flot.resize.min.js"></script>
