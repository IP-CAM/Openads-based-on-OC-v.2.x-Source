                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover" id="targeting-list">
                            ...
                            <tr onclick="load_component(this)" style="cursor: pointer" data-entry="<?php echo $item['targeting_id']; ?>" data-advertise="<?php echo $item['advertise_sn']; ?>">
...
<script type="text/javascript">
    $('#targeting-list > tbody > tr[data-entry="<?php echo $selected ?>"]').trigger('click');

    function load_component(el){
        $('#targeting-list tr.active-line').removeClass('active-line');
        $(el).addClass('active-line');
        $('#panel-header').text('<?php echo $text_edit ?> : '+ $(el).attr('data-advertise'));
        $('#detail-panel').load('index.php?route=service/advertise_targeting/detail&token=<?php echo $token?>&targeting_id='+$(el).attr('data-entry'));
    }

    function filter(){
        var url = 'index.php?route=service/advertise_targeting&token=<?php echo $token; ?>',
        paramArr=[];
