          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'p.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'p.code') { ?>
                  ...
                  <td class="text-center"><?php if ($sort == 'p.user_id') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'p.date_added') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($item['product_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['product_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['product_id']; ?>" />
                    <?php } ?></td>
