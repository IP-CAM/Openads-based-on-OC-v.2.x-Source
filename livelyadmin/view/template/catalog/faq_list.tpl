            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'f.title') { ?>
                    <a href="<?php echo $sort_title; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_title; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_title; ?>"><?php echo $column_title; ?></a>
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'f.is_top') { ?>
                  ...
                  <td class="text-center"><?php if ($sort == 'f.sort_order') { ?>
                    <a href="<?php echo $sort_sort_order; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort_order; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_sort_order; ?>"><?php echo $column_sort_order; ?></a>
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'f.date_added') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $faq['top']; ?></td>
                  <td class="text-center"><?php echo $faq['status']; ?></td>
                  <td class="text-center"><?php echo $faq['sort_order']; ?></td>
                  <td class="text-center"><?php echo $faq['date_added']; ?></td>
