            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'p.type') { ?>
                  ...
                  <td class="text-left"><?php if ($sort == 'p.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'p.value') { ?>
                  ...
                  <td class="text-center"><?php if ($sort == 'p.sort') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'p.default') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($item['option_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['option_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['option_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo ucfirst($item['type']); ?></td>
                  ...
                  <td class="text-center"><?php echo $item['default']; ?></td>
