                            ...
                            <form method="post" id="post-save-form">
                         	<div class="panel panel-primary">
                         		...
                         		<div class="panel-body">
                                    ...
                                    <?php if($edit){ ?>
                                        <input type="text" name="expired_date" value="<?php echo $expired;?>" class="form-control cdate" data-date-format="YYYY-MM-DD"/>
                                    <?php }else{ ?>
...
$('#tabdt-history').load('index.php?route=fbpage/profile_nophoto/history&token=<?php echo $token;?>&contribute_id=<?php echo $contribute_id;?>');
...
$('#btn-save').bind('click',function(){
    ...
    $.ajax({
        url:'index.php?route=fbpage/profile_nophoto/save&token=<?php echo $token;?>',
        type:'POST',
