            ...
            <div class="col-sm-3">
              <div class="form-group">
                ...
                <select name="filter_in_charge" id="input-in-charge" class="form-control">
                  ...
                  <?php if ($filter_in_charge == $item['user_id']) { ?>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="javascript:;"><?php echo $column_advertise; ?>
                  </td>
                  <td class="text-center"><?php if ($sort == 'c.in_charge') { ?>
                  ...
                  <td class="text-center"><?php if ($sort == 'c.user_id') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><?php echo $customer['advertise']; ?></td>
                  <td class="text-center"><?php echo $customer['charger']; ?></td>
                  <td class="text-center"><?php echo $customer['operator']; ?></td>
                  ...
                  <td class="text-right">                   
                    ...
                    <a href="index.php?route=customer/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>" target="_blank" class="btn btn-info"><i class="fa fa-sign-in"></i> <?php echo $text_login; ?></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
