            ...
            <div class="panel-body">
                <form action="<?php echo $restore; ?>" method="post" enctype="multipart/form-data" id="form-restore" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"><input type="file" name="import" id="input-import"/></div>
                    </div>
                </form>
                <form action="<?php echo $backup; ?>" method="post" enctype="multipart/form-data" id="form-backup" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" name="mode" value="0"/> <?php echo $text_structure ?> 
                            <input type="radio" name="mode" value="1" checked/> <?php echo $text_data ?>  
                            <input type="radio" name="mode" value="2"/> <?php echo $text_structure_data ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label"><?php echo $entry_backup; ?></label>
                        <div class="col-sm-10">
                            <div class="well well-sm" style="height: 380px; overflow: auto;">
