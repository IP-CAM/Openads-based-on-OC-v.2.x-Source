                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-role">
                        ...
                        <table class="table table-border">
                            ...
                            <tr>
                                <td>
                                    <span data-toggle="tooltip" title="<?php echo $help_group_promoter; ?>"><?php echo $entry_group_promoter; ?></span>
                                </td>
                                <td>
                                    <div id="member-promoter" class="view-block">
                                        <?php foreach ($users as $item) { ?>
                                        <?php if (in_array($item['user_id'], $ad_group_promoter)) { ?>
                                        <label class="label label-default"><?php echo $item['nickname']; ?></label>
                                        <?php } ?>
                                        <?php } ?>
                                    </div>
                                    <div id="setup-promoter" class="well well-sm edit-block" style="display: none">
                                        <?php foreach ($users as $item) { ?>
                                        <div class="checkbox-inline">
                                            <label>
                                                <?php if (in_array($item['user_id'], $ad_group_promoter)) { ?>
                                                <input type="checkbox" name="ad_group_promoter[]" value="<?php echo $item['user_id']?>" checked>
                                                <?php echo $item['nickname']; ?>
                                                <?php }else{ ?>
                                                <input type="checkbox" name="ad_group_promoter[]" value="<?php echo $item['user_id']?>">
                                                <?php echo $item['nickname']; ?>
                                                <?php } ?>
                                            </label>
                                        </div>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-member" data-key="promoter"><?php echo $text_role_member?></a>
                                    <a class="btn btn-primary btn-menu" data-key="promoter"><?php echo $text_role_menu?></a>
                                </td>
                            </tr>
                        </table>
                        </form>
