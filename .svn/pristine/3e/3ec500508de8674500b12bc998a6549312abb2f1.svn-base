...
class ControllerCustomerCustomerGroup extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm('customer/customer_group/add')) {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm('customer/customer_group/edit')) {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete('customer/customer_group/delete')) {
	...
	protected function getForm() {
		...
		} elseif (!empty($customer_group_info['name'])) {
		...
		if (isset($this->request->post['note'])) {
			...
			$data['note'] = $customer_group_info['note'];
		} else {
			$data['note'] = '';
		}
