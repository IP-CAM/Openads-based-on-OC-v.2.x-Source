            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'username') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">
                    <a href="jascript:;"><?php echo $column_fullname; ?></a>
                  </td>
                  <td class="text-left">
                    <?php echo $column_roles; ?>
                  </td>
                  <td class="text-left"><?php if ($sort == 'status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'author_id') { ?>
                    <a href="<?php echo $sort_author_id; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_author_id; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_author_id; ?>"><?php echo $column_author_id; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left col-sm-2"><span title="<?php echo $user['roles']; ?>"><?php echo lively_truncate($user['roles'],360); ?></td>
                  <td class="text-left"><?php echo $user['status']; ?></td>
                  <td class="text-left"><?php echo $user['author_id']; ?></td>
