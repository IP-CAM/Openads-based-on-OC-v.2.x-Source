          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'p.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'p.money') { ?>
                  ...
                  <td class="text-left"><?php if ($sort == 'p.sort') { ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($item['priority_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['priority_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['priority_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $item['name']; ?></td>
                  <td class="text-left"><?php echo $item['money']; ?></td>
                  <td class="text-left"><?php echo $item['sort']; ?></td>
