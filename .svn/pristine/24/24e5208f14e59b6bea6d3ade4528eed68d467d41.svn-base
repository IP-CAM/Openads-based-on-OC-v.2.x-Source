...
<script type="text/javascript">
    $('#tab-history').load('index.php?route=nfl/post_player/history&token=<?php echo $token;?>&contribute_id=<?php echo $contribute_id;?>');
    ...
    $('#btn-relax').bind('clcik', function(){
        if(confirm('<?php echo $text_confirm_relax ?>')){
            var res = resetTempLocker('index.php?route=nfl/post_player/ajax_data&set=1&token=<?php echo $token;?>',<?php echo (int)$contribute_id;?>,<?php echo (int)$locker;?>);
