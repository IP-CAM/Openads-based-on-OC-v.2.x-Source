...
$('#tab-history').load('index.php?route=fbaccount/profile_nophoto/history&token=<?php echo $token;?>&contribute_id=<?php echo $contribute_id;?>');
...
$('#btn-save').bind('click',function(){
    ...
    $.ajax({
        url:'index.php?route=fbaccount/profile_nophoto/save&token=<?php echo $token;?>',
        type:'POST',
