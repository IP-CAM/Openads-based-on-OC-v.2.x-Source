          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($item['language_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['language_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $item['language_id']; ?>" />
                    <?php } ?></td>
