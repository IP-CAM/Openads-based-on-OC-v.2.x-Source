          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class='input-group date'>
                <input type="text" name="start_date" value="<?php echo $start_date; ?>" placeholder="<?php echo $entry_start_date; ?>" id="input-start-date" class="date form-control" data-date-format="YYYY-MM-DD" placeholder="YYYY-MM-DD"/>
