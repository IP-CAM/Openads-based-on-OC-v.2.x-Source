    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <a id="btn-export" class="btn btn-primary" data-toggle="tooltip" title="<?php echo $button_export; ?>"><span class="glyphicon glyphicon-export"></span></a>
            </div>
    ...
    buttons:{
        'Save':function(){
            $('#bulk-form').ajaxSubmit({
                url:'index.php?route=fbpage/publish_nophoto/bulk&token=<?php echo $token;?>',
                type:'Post',
                dataType:'json',
...
function filter() {
	url = 'index.php?route=fbpage/publish_nophoto&token=<?php echo $token; ?>';
	var paramArr=[];
